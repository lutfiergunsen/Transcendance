function gameAdd() {
  ...
  const profileImage = localStorage.getItem('profileImage');
    ...
    <div class="profil-backgraund">
        ...
        <p class="button-info">
           <strong H6 data-translate="infogame"></strong> <hr>
            <strong data-translate="1vs1"></strong> <br> [W - S] [O - L] <hr>
            <strong data-translate="2vs2"></strong> <br> [W - S] [Q - A] -- [O - L] [U - J] <hr>
            <strong data-translate="turnuvamodu"></strong> <H6 data-translate="turnuvamodu2"><H6> 
        </p>
        </div>
